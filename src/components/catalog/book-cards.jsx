...
export function BookPriceAndRating({ price, rating, discount }) {
  return (
    <div className="book-pricing-and-rating">
      ...
      <p className="selling-book-price text-base font-bold text-gray-700 ml-2">₹{price * (100 - discount)/100}</p>
      <p className="book-price-discount text-base font-bold text-gray-700 ml-2 text-green-600">{discount}% off</p>
